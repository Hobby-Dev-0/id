...
CmdHelp("core").add_command(
  "install", "<reply to a .py file>", "Installs the replied python file if suitable to speedøbøt's codes."
).add_command(
  "uninstall", "<plugin name>", "Uninstalls the given plugin from speedøbøt. To get that again do .restart", "uninstall alive"
).add_command(
